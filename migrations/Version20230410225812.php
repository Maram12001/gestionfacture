 ...
 */
final class Version20230410225812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ligne_produit_client (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, facture_client_id INT NOT NULL, prix_unitaire DOUBLE PRECISION NOT NULL, remise DOUBLE PRECISION NOT NULL, INDEX IDX_AA8FDA0F347EFB (produit_id), INDEX IDX_AA8FDA0D34354A5 (facture_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE workflowpaiement (id INT AUTO_INCREMENT NOT NULL, facture_fournisseur_id INT NOT NULL, date_emission DATETIME NOT NULL, INDEX IDX_C7D80DD3C755704D (facture_fournisseur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
